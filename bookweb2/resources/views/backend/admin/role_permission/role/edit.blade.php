                                        ...
                                        <?php foreach($modulePermission as $permission): ?>
                                            <div class="mt-2">
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" name="permission_id[]" value="<?php echo $permission->id; ?>" id="<?php echo $permission->slug; ?>" class="permission" <?php echo in_array($permission->id, $role->permissions->pluck('id')->toArray()) ? 'checked' : ''; ?>>
                                                    <label for="<?php echo $permission->slug; ?>"><?php echo $permission->name; ?></label>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    <?php endforeach; ?>
